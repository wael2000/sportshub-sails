...
var NumberController = {
     ...
     * @return {string}
     */
    getDedicatedNumbers: function (callback) {


        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/numbers";
     ...
     * @return {string}
     */
    purchaseDedicatedNumber: function (dedicatedNumber, callback) {

        //validating required parameters
        if (dedicatedNumber == null || dedicatedNumber == undefined){
            return callback({errorMessage: "The parameter 'dedicatedNumber' is a required parameter and cannot be null.", errorCode: -1}, null, null);
        }

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/numbers/buy/{dedicated_number}";
     ...
     * @return {string}
     */
    getDedicatedNumbersByCountry: function (country, search, searchType, callback) {

        //validating required parameters
        if (country == null || country == undefined){
            return callback({errorMessage: "The parameter 'country' is a required parameter and cannot be null.", errorCode: -1}, null, null);
        }

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/numbers/search/{country}";
